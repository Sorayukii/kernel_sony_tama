...
ANYKERNEL_REPO="https://github.com/KanonifyX/AnyKernel3"
ANYKERNEL_BRANCH="aurora-jp"
ANYKERNEL_DIR="$KERNEL_DIR/AnyKernel3"

# Kernel zip file name
KERNEL_NAME="JP_Starfield_kernel_aurora"
...
if [ -f "$KERNEL_IMAGE" ]; then
    ...
    # Create flashable zip
    cd "$ANYKERNEL_DIR"
    ZIP_NAME="${KERNEL_NAME}-${KERNEL_COMMIT_ID}-$(date +%Y%m%d).zip"
